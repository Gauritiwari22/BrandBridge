    ...
    <div className="grid min-h-screen md:grid-cols-2">
      <div className="relative hidden overflow-hidden bg-hero-gradient md:block">
        ...
        <div className="relative flex h-full flex-col justify-between p-12 text-white">
          <Link to="/" className="flex items-center gap-2"><Sparkles className="h-6 w-6" /><span className="font-display text-2xl font-bold">BrandBridge</span></Link>
          <div>
      ...
      <div className="flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <Button type="button" variant="outline" className="mt-6 w-full" onClick={signInWithGoogle} disabled={loading}>
