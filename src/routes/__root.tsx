...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BrandBridge AI — Connect brands, creators & campuses" },
      { name: "description", content: "BrandBridge AI matches brands with influencers, student ambassadors, and college events. Run campaigns, sign contracts, and track ROI in one platform." },
    ],
    links: [
